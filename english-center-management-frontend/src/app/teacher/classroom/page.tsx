            ...
            >
              ...
              <div className='bg-gradient-to-r from-blue-500 to-blue-600 p-6 text-white'>
                <div className='flex justify-between items-start mb-3'>
                  <div className='flex-1'>
                    <h3 className='text-xl font-bold mb-2 group-hover:text-blue-50 transition-colors'>
              ...
              <div className='p-6'>
                ...
                <Link
                  ...
                  className='group/button w-full flex items-center justify-center bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white px-4 py-3 rounded-lg font-medium transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98]'
                >
